...
- **15 learning paths** — curated journeys through the library, each marking your next course; a path stays hidden until at least one of its courses ships, so content and configuration can drift without breaking the UI.
