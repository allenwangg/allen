...
(function () {
  ...
  /* Cover illustration per course. Kept explicit rather than derived so a
     course reads as itself in the grid; entries may name a course that has
     not shipped yet. */
  var COVER_ART = {
    'african-kingdoms': 'crown', 'animal-minds': 'eye', 'anthropology': 'network',
    'archaeology': 'layers', 'architecture': 'bridge', 'art-history': 'palette',
    'art-of-storytelling': 'map', 'art-of-strategy': 'puzzle', 'astronomy': 'orbit',
    'attention-age': 'target', 'big-ideas-physics': 'orbit', 'biology-of-aging': 'clock',
    'brain-on-emotions': 'flame', 'career': 'path', 'chemistry': 'atom',
    'child-development': 'ladder', 'cities': 'bridge', 'climate-system': 'globe',
    'cognitive-biases': 'lens', 'comparative-religion': 'compass', 'computing': 'gear',
    'conflict': 'bridge', 'consciousness': 'mirror', 'creativity': 'lightbulb',
    'cryptography': 'key', 'dance': 'flame', 'decisions': 'door',
    'demography': 'graph', 'design': 'grid', 'eastern-philosophy': 'wave',
    'ecology': 'seed', 'emotional-intelligence': 'heart', 'energy': 'flame',
    'entrepreneurship': 'ladder', 'epistemology': 'lens', 'ethics-big-three': 'compass',
    'ethics-of-immortality': 'balance', 'exercise-science': 'mountain', 'existentialism': 'fork',
    'film': 'lens', 'free-will': 'path', 'fungi': 'network',
    'genes-and-editing': 'dna', 'genius-of-language': 'book', 'geology': 'layers',
    'great-experiments': 'microscope', 'healthspan-playbook': 'pill', 'history-of-medicine': 'shield',
    'how-ai-works': 'grid', 'how-doctors-think': 'lens', 'how-economies-work': 'loop',
    'how-internet-works': 'globe', 'how-things-spread': 'network', 'how-to-live-forever': 'hourglass',
    'immortal-animals': 'feather', 'immune-system': 'shield', 'imperial-china': 'pyramid',
    'india-legacy': 'lightbulb', 'indigenous-knowledge': 'ship', 'infinity': 'orbit',
    'islamic-golden-age': 'key', 'japan-aesthetics': 'leaf', 'latin-america': 'ship',
    'law-and-justice': 'balance', 'leadership': 'crown', 'learning-how-to-learn': 'brain',
    'logic': 'puzzle', 'logical-fallacies': 'balance', 'longevity-trials': 'funnel',
    'materials': 'crystal', 'meaning-of-life': 'compass', 'media-literacy': 'funnel',
    'memory-science': 'anchor', 'mental-health': 'mirror', 'microbiome': 'cell',
    'money-in-history': 'pyramid', 'music-and-brain': 'bell', 'music-theory': 'note',
    'mythology': 'mask', 'negotiation': 'bridge', 'nutrition-without-nonsense': 'seed',
    'oceans': 'wave', 'origin-of-life': 'flask', 'pain-and-placebo': 'bell',
    'personal-finance': 'lock', 'persuasion': 'dialog', 'philosophy-of-science': 'lens',
    'photography': 'eye', 'plants': 'leaf', 'poetry': 'book',
    'political-philosophy': 'balance', 'probability-and-luck': 'fork', 'psychology-of-happiness': 'key',
    'psychology-of-money': 'coin', 'public-speaking': 'column', 'radical-life-extension': 'spectrum',
    'risk': 'balance', 'russian-literature': 'feather', 'science-of-habits': 'seed',
    'science-of-sleep': 'hourglass', 'senses': 'eye', 'space-exploration': 'telescope',
    'statistics': 'graph', 'stock-market-explained': 'graph', 'stoicism': 'shield',
    'story-of-evolution': 'tree', 'systems-thinking': 'network', 'theatre': 'dialog',
