 ...
 */
const VERSION = 'vitalarc-2cc04b03858e518d';   // stamped by scripts/stamp-sw.mjs
const SHELL = [
  './', './index.html', './css/app.css',
  './js/app.js', './js/ui.js', './js/engine.js', './js/insights.js',
  './js/model.js', './js/store.js', './js/charts.js', './js/entitlements.js',
  './js/billing.js', './js/sample.js',
