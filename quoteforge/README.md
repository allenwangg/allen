...
260 unit assertions with no test framework and no install step, plus 323 browser
...
and `test/mobile.mjs`, which walks the whole funnel on an emulated 390px touch phone:
